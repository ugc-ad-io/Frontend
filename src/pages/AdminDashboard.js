    ...
    <div className="admin-dashboard">
      ...
      <div className="dashboard-content">
        ...
        <div className="tab-content">
          ...
          {/* Campaigns, Withdrawals, All Campaigns, Users, Assignments tabs are now separate pages */}
          ...
          {/* Flagged Messages moved to /dashboard/admin/flagged (AdminFlaggedMessages.js) */}
          ...
          {/* Analytics moved to /dashboard/admin/analytics (AdminAnalytics.js) */}
          ...
          {/* Analytics handled by separate route /dashboard/admin/analytics */}
        </div>
      </div>
      </main>
